...
#SBATCH --account=open
#SBATCH --output=Output_Mean/output_thresh_%A_%a.out
#SBATCH --array=1-800
...
file="/storage/work/krf5429/GNG-Inhibition-Task/Simulation/Data_Mean/${dist}_thresh_roi_snr${snr}_${rep}.RData"
